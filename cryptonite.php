        ...
        if (mysqli_num_rows($result) !=0 ) { 
            ...
            if($token == null || $token == $_SESSION['token']){
                ...
                if($product_name == 'Crypto-Nite5'){
                    ...
                    // header("Location: user-login");
                } else if($product_name == 'Crypto-Nite 2020' || $product_name == 'Crypto-Nite2' || $product_name == 'Crypto-Nite3' || $product_name == 'Crypto-Nite4'){
                    $new_batch = false;
                    if(isset($_GET['day'])){
                ...
                <div id="live-q&a" class="tabcontent">
                    ...
                    <div style="display:flex;justify-content:center;">
                        ...
                        border-radius:15px;padding:0;">
                            ...
                            <div class="col-md-5" style="padding:18px;text-align:center;background-color:#fff;border-radius:15px;margin-left:6px;">
                                <a href="https://youtu.be/VTy_Kys2VdQ" target="_blank" style="color:#000;">Join Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="display:flex;justify-content:center;">
                        ...
                        border-radius:15px;padding:0;">
                            ...
                            <div class="col-4" style="padding:18px;text-align:center;background-color:#fff;border-radius:15px;margin-left:6px;">
                                <a href="https://youtu.be/VTy_Kys2VdQ" target="_blank" style="color:#000;">Join</a>
                            </div>
                        </div>
                    </div>
                    <?php
