                ...
                <div id="select-day" class="tabcontent font-roboto-r">
                            ...
                            <div class="col-md-5" style="padding:18px;text-align:center;background-color:#fff;border-radius:15px;margin-left:6px;">
                                ...
                                <?php 
                                    ...
                                    if($day == "1"){ 
                                        ...
                                        echo '<a href="cryptonite-test?day=1" style="color:#000;">Watch Now</a>';
                                    }
                            ...
                            <div class="col-md-5" style="padding:18px;text-align:center;background-color:#fff;border-radius:15px;margin-left:6px;">
                                <?php 
                                    ...
                                    if($day == "2"){ 
                                        ...
                                        echo '<a href="cryptonite-test?day=2" style="color:#000;">Watch Now</a>';
                                    }
                    ...
                    <div style="display:flex;justify-content:center;margin-top:20px;">
                        ...
                        border-radius:15px;padding:0;">                            
                            ...
                            <div class="col-md-5" style="padding:18px;text-align:center;background-color:#fff;border-radius:15px;margin-left:6px;">
                                <a class="link1" style="color:#000;">Unlocks in <span class="mins1">24</span>hrs</a>
                            </div>
                        </div>
                    </div>
                ...
                <div id="live-q&a" class="tabcontent">
                    <div style="display:flex;justify-content:center;">
                        ...
                        border-radius:15px;padding:0;">
                            ...
                            <div class="col-md-5" style="padding:18px;text-align:center;background-color:#fff;border-radius:15px;margin-left:6px;">
                                <a href="https://www.youtube.com/watch?v=L1qm8j1_eGI&feature=youtu.be" target="_blank" style="color:#000;">Join Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="select-day-mobile" class="tabcontent font-roboto-r">
                    ...
                    <div style="display:flex;justify-content:center;margin-top:20px;">
                        ...
                        border-radius:18px;padding:0;">
                            ...
                            <div class="col-5 d-flex justify-content-center align-items-center" style="padding:12px;text-align:center;background-color:#fff;border-radius:15px;">
                                <a class="link3" style="color:#000;">Unlocks in <span class="mins3">24</span>hrs</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="display:flex;justify-content:center;">
                        ...
                        border-radius:15px;padding:0;">
                            ...
                            <div class="col-4" style="padding:18px;text-align:center;background-color:#fff;border-radius:15px;margin-left:6px;">
                                <a href="https://www.youtube.com/watch?v=L1qm8j1_eGI&feature=youtu.be" target="_blank" style="color:#000;">Join</a>
                            </div>
                        </div>
                    </div>
                </div>
